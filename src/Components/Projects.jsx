...
const Projects = () => {
    ...
    return (
        <motion.div
            ...
            className='container mx-auto py-4 pt-20 mp-6 md:px-20
        lg:px-32 my-20 w-full overflow-hidden' id='Projects'>
            ...
            <div className='flex justify-end items-center mb-8'>
                <button onClick={prevproject}
                    className='p-3 bg-gray-200 rounded mtr-2' aria-label='Previous Projects'>
                    <img src={assets.left_arrow} alt="Previous" />
                </button>
                <button onClick={nextproject}
                    className='p-3 bg-gray-200 rounded mtr-2' aria-label='Next Projects'>

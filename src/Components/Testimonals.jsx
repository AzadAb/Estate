...
const Testimonals = () => {
    return (
        <motion.div
            ...
            <h1 className='text-2xl sm:text-4xl font-bold mb-2 text-center mx-auto'>Customer <span className='underline underline-offset-4 decoration-1 under font-light'>Testimonials</span></h1>

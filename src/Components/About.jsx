        ...
        container mx-auto p-14 md:px-20 lg:px-32 w-full overflow-hidden' id='About'>
            ...
            <div className="flex flex-col md:flex-row items-center md:items-start md:gap-20">
                ...
                <div className='flex flex-col items-center md:items-start mt-10 text-gray-600'>
                    ...
                    <p className='my-10 max-w-lg'>This project is a platform for listing and searching real estate properties. It helps users find homes by location, price, and type. Users can see property details and contact sellers easily. The goal is to make buying and selling property simple and convenient.</p>

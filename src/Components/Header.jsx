...
const Header = () => {
    return (
        ...
        items-center w-full overflow-hidden' style={{ backgroundImage: "url('public/header_img.png')" }} id='Header'>
            <Navbar />
            <motion.div initial={{ opacity: 0, y: 100 }} transition={{ duration: 1.5 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className='container text-center mx-auto py-4 px-6 md:px-20 lg:px-32 text-white'>
                ...
                <div className='space-x-6 mt-16'>
                    ...
                    <a href="#Contact" className=' bg-blue-500 px-8 py-3 rounded'>Contacts</a>
                </div>
